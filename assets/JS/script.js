...
$.ajax({
    ...
    .then(function (response) {
        ...
        $("#Date2").html("<img src=http://openweathermap.org/img/w/" + response.list[0].weather[0].icon + ".png>");
        ...
        $("#Date3").html("<img src=http://openweathermap.org/img/w/" + response.list[8].weather[0].icon + ".png>");
        ...
        $("#Date4").html(response.name + "<img src=http://openweathermap.org/img/w/" + response.list[16].weather[0].icon + ".png>");
        ...
        $("#Date5").html(response.name + "<img src=http://openweathermap.org/img/w/" + response.list[24].weather[0].icon + ".png>");
        ...
        $("#Date6").html(response.name + "<img src=http://openweathermap.org/img/w/" + response.list[32].weather[0].icon + ".png>");
